...
仓库：https://github.com/dshoneys/mcp_guard
...
macOS 若链接 `MacOSX27.sdk` 失败，先固定一个稳定 SDK。菜单栏 `.app` 打包见 [`doc/structurizr/MACOS-APP.md`](doc/structurizr/MACOS-APP.md)，脚本 `./scripts/macos_pack_app.sh`。
